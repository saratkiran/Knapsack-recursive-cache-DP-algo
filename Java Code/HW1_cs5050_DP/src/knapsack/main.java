 ...
 * Uncomment the code between the horizontal dotted lines for corresponding solutions
 */

public class main {

    public static int randvariables[] = new int[5000];
    public static int randvalues[] = new int [5000];

    public static void main(String[] args) {
        int no_objects = 40; // What should be the number of objects.


            try{
                BufferedWriter out = new BufferedWriter(new FileWriter("filers.txt"));// to write output into a txt file
                for(int l =0;l<30;l++){ 				// number of times each instance to be repeated
					...
					//System.out.println(Arrays.toString(randvariables)); // to print the random objects weights
					//System.out.println(Arrays.toString(randvalues));  	// to print the random objects values

                    int cap = no_objects*10;  // total capacity for problem 2 - wide and narrow
                    //int cap = 1000; // for the recursive case
